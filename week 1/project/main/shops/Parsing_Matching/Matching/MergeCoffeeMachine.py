...
from project.main.shops.Parsing_Matching.Parsing.CoffeMachineParsers.BelyVeterCoffeMachine import belyveter_coffee_machine as bely_veter_items
from project.main.shops.Parsing_Matching.Parsing.CoffeMachineParsers.TechnodomCoffeeMachine import technodom_coffee_machine as technodom_items
from project.main.shops.Parsing_Matching.Parsing.CoffeMachineParsers.MechtaCoffeeMachine import mechta_coffee_machine as mechta_items
from project.main.shops.Parsing_Matching.Parsing.CoffeMachineParsers.SulpakCoffeeMachine import sulpak_coffee_machine as sulpak_items
...
def main(conn,cursor):
    ...
    for i in ans:
        for j in i:
        #     print('Name:', j[0], 'price:', j[1], 'from:', j[2])
        # print('--------------------------------------')
            insert_device = """ INSERT INTO shops_item (name, category_id, shop_id) 
                                                VALUES (%s,%s,%s)
                                            """
            record_to_device = (j[0], category_id, shop_id[j[2]])
